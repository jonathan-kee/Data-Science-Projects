with max_date_stg_inventory as (
...
filter_stg_inventory_max_date as (
    ...
    where stg_inventory."date_part" = max_date_stg_inventory."max_date_part"
...
total_selling_price_max_date as (
    select distinct
        ...
        filter_stg_inventory_max_date."Amount" * filter_stg_prices_max_date."AI1-BidPrice" as "total_selling_price"
